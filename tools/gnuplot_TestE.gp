...
set output ARG1."/plot4.png"
plot ARG1."/plot4/plot-5201.txt" using 1:2 with lines title "node1", \
     ARG1."/plot4/plot-5202.txt" using 1:2 with lines title "node2", \
     ARG1."/plot4/plot-5203.txt" using 1:2 with lines title "node3"
